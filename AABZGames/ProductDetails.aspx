<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProductDetails.aspx.cs" Inherits="AABZGames.ProductDetails" %>
                ...
                <ItemTemplate>
                    <div class="col-md-10">
                        <div class=" productDes">
                                ...
                                <div>
                                    <span class="productDescPrice"><%# (Convert.ToDouble(Eval("price"))).ToString("C") %></span>
                                    ...
                                    <p><asp:Label runat="server" class="productDescription" Text='<%# Eval("Description") %>'></asp:Label></p>
                                </div>
